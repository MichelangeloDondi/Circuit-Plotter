...
module OverlappingCheck
    ...
    # ==============================================================================
        ...
        - This function is used by the function `add_edge_to_circuit(node1::Int, node2::Int, edge_info, circuit)::Bool` in Module 'GatheringEdges'.
        """
        function overlapping_edges(new_edge, existing_edges, nodes)::Vector{Tuple{Int, Tuple{Int, Int}}}
    ...
    # ==============================================================================
        ...
        - This function called by the function `overlapping_edges(new_edge, existing_edges, nodes)::Vector{Tuple{Int, Tuple{Int, Int}}}`.
        """
        function _do_overlap(p1, q1, p2, q2)::Bool
    ...
    # ------------------------------------------------------------------------------
        ...
        Notes:
        - This function is not exported.
        - This function called by the function `_do_overlap(p1, q1, p2, q2)::Bool`.
        """
        function _orientation(p, q, r)::Int
